 ...
 */
public abstract class CNTransPlugin extends JavaPlugin {
    ...
    protected static CNTransPlugin plugin;
    ...
    protected static boolean forge = Loader.forName("net.minecraftforge.classloading.FMLForgePlugin", false, CNTransPlugin.class.getClassLoader()) != null;
...
//    }
    ...
    private static Class<?> getMainClass() {
        ...
        try {
            ZipFile zipFile = new ZipFile(toFile(CNTransPlugin.class.getProtectionDomain().getCodeSource().getLocation().openStream(), file));
    ...
    private static void init() {
        ...
        if (!libFile.exists()) {
            // 本地资源检测
            InputStream resourceAsStream = CNTransPlugin.class.getClassLoader().getResourceAsStream("TabooLib.jar");
    ...
    public static CNTransPlugin getPlugin() {
        return plugin;
    }
